...
class KnowledgeItem(Base):
    """Stores knowledge across all MCP domains - matches existing DB schema."""
    ...
    relevance_domains = Column(JSONB, nullable=False, default=list)
    sophistication_level = Column(String(50), nullable=False, default='basic')
    cross_domain_applicability = Column(Float, nullable=False, default=0.0)
...
class APIUsageAnalytics(Base):
    ...
    analytics_metadata = Column(JSONB, nullable=False, default=dict)
